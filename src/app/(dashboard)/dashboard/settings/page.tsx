...
import { RefreshCw, LogOut, CheckCircle, XCircle, Loader2 } from "lucide-react";
    ...
    <div className="space-y-6 max-w-xl">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manually trigger a news fetch and sentiment analysis for your watchlist stocks.
        ...
        <CardContent className="space-y-4">
          ...
          {pipelineStatus === "error" && (
            <div className="rounded-lg bg-muted p-3 flex items-center gap-2 text-red-500 text-sm">
              <XCircle className="h-4 w-4 shrink-0" />
              Pipeline failed. Check that PIPELINE_SECRET is set correctly.
            </div>
          )}
        </CardContent>
      </Card>
