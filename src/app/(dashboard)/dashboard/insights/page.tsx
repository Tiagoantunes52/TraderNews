...
const DRIFT_HINT =
  "Change in the watchlist's article-weighted aggregate sentiment over the last 30 days. ▲ positive = mood improving, ▼ negative = worsening.";
const CORRELATION_HINT =
  "Correlation r, from −1 to +1: how closely a stock's daily sentiment tracks the next day's price move. |r| ≥ 0.6 is strong, ≥ 0.3 moderate, ≥ 0.1 weak. Needs at least 5 paired days.";
import {
  THRESHOLDS,
  SIGNAL_HINTS,
  classifySentiment,
...
export const metadata = { title: "Watchlist Insights — TraderNews" };
...
export default async function WatchlistInsightsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Watchlist Insights</h1>
      ...
      {empty ? (
        <Card className="rounded-2xl">
          <CardContent className="py-16 text-center">
            ...
            <p className="text-muted-foreground text-sm mt-1">
              Add stocks to your watchlist to see watchlist-wide insights
            </p>
          </CardContent>
        </Card>
      ) : (
                ...
                <div className="text-right">
                  ...
                  {drift !== null && (
                    <p className="text-white/90 text-sm mt-2 tabular-nums">
                      ...
                      <Hint
                        text={DRIFT_HINT}
                        className="text-white/70 underline decoration-dotted decoration-white/50 underline-offset-2"
                      >
                        30d drift
                      </Hint>
                    </p>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm flex items-center gap-2">
                ...
                <Hint text={CORRELATION_HINT} className={HINT_TEXT}>Sentiment → price correlation</Hint>
              </CardTitle>
            </CardHeader>
            <CardContent>
