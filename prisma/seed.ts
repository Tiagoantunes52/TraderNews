...
// US equities — the primary trading + data-coverage universe (paper trading is
// US-equity only). Grouped by sector for maintainability; the NYSE/NASDAQ label is
// display-only (US market routing is suffix-based in market-utils), so it's
// best-effort primary listing. SPY/QQQ are kept as ETFs (SPY is the benchmark).
const usEquities: SeedStock[] = [
  ...
  // SpaceX — IPO'd 2026-06-12 on Nasdaq (ticker SPCX).
  { ticker: "SPCX", name: "Space Exploration Technologies Corp. (SpaceX)", market: "NASDAQ" },
  // Software / SaaS
  ...
  { ticker: "ANET", name: "Arista Networks", market: "NYSE" },
  { ticker: "VRT", name: "Vertiv Holdings", market: "NYSE" },
  { ticker: "SMCI", name: "Super Micro Computer", market: "NASDAQ" },
  { ticker: "COHR", name: "Coherent Corp.", market: "NYSE" },
  { ticker: "LITE", name: "Lumentum Holdings", market: "NASDAQ" },
  // Financials
  { ticker: "JPM", name: "JPMorgan Chase & Co.", market: "NYSE" },
  { ticker: "BAC", name: "Bank of America", market: "NYSE" },
  { ticker: "WFC", name: "Wells Fargo & Co.", market: "NYSE" },
  { ticker: "GS", name: "Goldman Sachs Group", market: "NYSE" },
  { ticker: "MS", name: "Morgan Stanley", market: "NYSE" },
  { ticker: "BRK-B", name: "Berkshire Hathaway (Class B)", market: "NYSE" },
  ...
  { ticker: "DHR", name: "Danaher Corporation", market: "NYSE" },
  { ticker: "REGN", name: "Regeneron Pharmaceuticals", market: "NASDAQ" },
  { ticker: "VRTX", name: "Vertex Pharmaceuticals", market: "NASDAQ" },
  { ticker: "TEM", name: "Tempus AI", market: "NASDAQ" },
  ...
  { ticker: "CVNA", name: "Carvana Co.", market: "NYSE" },
  ...
  { ticker: "PM", name: "Philip Morris International", market: "NYSE" },
  ...
  { ticker: "RTX", name: "RTX Corporation", market: "NYSE" },
  { ticker: "LMT", name: "Lockheed Martin", market: "NYSE" },
  { ticker: "BA", name: "The Boeing Company", market: "NYSE" },
  { ticker: "ETN", name: "Eaton Corporation", market: "NYSE" },
  { ticker: "PH", name: "Parker-Hannifin", market: "NYSE" },
  { ticker: "EME", name: "EMCOR Group", market: "NYSE" },
  { ticker: "FIX", name: "Comfort Systems USA", market: "NYSE" },
  ...
  { ticker: "RDDT", name: "Reddit Inc.", market: "NYSE" },
  { ticker: "SPOT", name: "Spotify Technology", market: "NYSE" },
  { ticker: "FOXA", name: "Fox Corporation", market: "NASDAQ" },
  // REITs / utilities
  { ticker: "PLD", name: "Prologis Inc.", market: "NYSE" },
  ...
  // Recent IPOs / growth
  { ticker: "CAVA", name: "CAVA Group", market: "NYSE" },
  { ticker: "CART", name: "Maplebear Inc. (Instacart)", market: "NASDAQ" },
  { ticker: "TOST", name: "Toast Inc.", market: "NYSE" },
  { ticker: "DUOL", name: "Duolingo Inc.", market: "NASDAQ" },
  // Benchmark ETFs (SPY is the calibration/alpha benchmark)
...
const uk: SeedStock[] = [
  ...
  { ticker: "BA.L", name: "BAE Systems", market: "LSE" },
